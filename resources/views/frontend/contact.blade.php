...
<main>
            ...
            <div class="contact-area">
                <div class="container">
                    <form action="{{route('store.contact')}}" class="contact__form" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-lg-6">
                                <div class="homeContact__form">
                                    <form action="{{route('store.contact')}}" method="POST">
                                        ...
                                        <textarea name="message" placeholder="Enter Massage*" name="message" required></textarea>
