...
<ul class="navigation">
<li class="{{ !in_array($route, ['home.about','home.portfolio','home.blog','contact.me']) ? 'active' : '' }}"><a href="{{url('/')}}">Home</a></li>

<li class="{{($route== 'home.about')? 'active' : ''}}"><a href="{{route('home.about')}}">About</a></li>

<!-- <li><a href="services-details.html">Services</a></li> -->
<li class="menu-item-has-children {{($route== 'home.portfolio')? 'active' : ''}}"><a href="{{route('home.portfolio')}}">Projects</a>
    
</li>

<li class="menu-item-has-children {{($route== 'home.blog')? 'active' : ''}}"><a href="{{route('home.blog')}}">Our Blog</a>
