...
$workhistory = App\Models\WorkHistory::latest()->get();
$educationdetails = App\Models\EducationDetails::latest()->get();
@endphp
 <main>
            <!-- breadcrumb-area -->
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6">
                            <div class="about__content">
                                ...
                                <a target="_blank" href="{{ asset($aboutpage->resume) }}" class="btn" download>Download my resume</a>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-12">
                            <div class="about__info__wrap">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    ...
                                    <li class="nav-item" role="presentation">
                                        <button class="nav-link" id="awards-tab" data-bs-toggle="tab" data-bs-target="#awards" type="button"
                                            role="tab" aria-controls="awards" aria-selected="false">Work History</button>
                                    </li>
                                    <li class="nav-item" role="presentation">
                                ...
                                <div class="tab-content" id="myTabContent">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="about__education__item">
                                                        <h3 class="title">{{$item->job_title}}</h3>
                                                        <h5 class="title" style="font-size:15px;">{{$item->company_name}}</h5>
                                                        <span class="date">{{$item->service_period}}</span>
                                                        {!!$item->description !!}
                                                    </div>
                                                </div>
                                                @endforeach
                                    ...
                                    <div class="tab-pane fade" id="awards" role="tabpanel" aria-labelledby="education-tab">
                                        <div class="about__education__wrap">
                                            <div class="row">
                                                <div class="row">
                            ...
                            <div class="blog__post__item">
                                <div class="blog__post__thumb">
                                    ...
                                    <div class="blog__post__tags">
                                        <a href="{{route('category.post',$item->blog_category_id)}}">{{$item['category']['blog_category']}}</a>
                                    </div>
                                </div>
