...
@php
$blogcategory = App\Models\BlogCategory::orderBy('blog_category','ASC')->get();
@endphp
...
<div class="page-content">
    <div class="container-fluid">
        ...
        <form class="form-horizontal mt-3" method="POST" action="{{route('store.blog')}}" enctype="multipart/form-data">
            @csrf
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input class="form-control" type="text" placeholder="" id="blog_title" value="" name="blog_title">
                @error('blog_title')
                <span class="text-danger">{{$message}}</span>
                @enderror
            </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-10">
                <input class="form-control " type="text" placeholder="" id="blog_tags" value="home,tech" name="blog_tags" data-role="tagsinput">
                 @error('blog_tags')
                <span class="text-danger">{{$message}}</span>
                @enderror
            </div>
